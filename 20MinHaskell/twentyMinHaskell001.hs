...
Unlike just a teaching language it is Industrial Strength
...
1972
    Dennis Richie's C language 
      ...
      it shows up everywhere because it works where resources are tight, 
	and performance must be pushed to the limit.
