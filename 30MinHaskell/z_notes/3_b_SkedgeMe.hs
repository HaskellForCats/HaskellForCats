...
Ryan Trinkle former C.T.O. @ SkedgeMe
  ...
  A Haskell to JS librabry to Deliver FRP to Front End Web Development.    
...
Recurring Events  
Notifications 
***Double-Bookings abound 
No Doc for the existing Codebase 
** Bad Performance form JVM
    interactive-es 60 sec load time  
Inflexible 
No Client Based Solutions 
    We Took the Netscape approach, 
        rewrite it? 
Monads 
...
easier than other testing stratagies 
